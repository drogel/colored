...
const testColorSuggestionsApiResponse = {
  ...
  "data": {
    ...
    "pageIndex": 1,
    "totalPages": 1,
    "selfLink": "https://test.com/suggestions/colors/random?size=3",
    "items": [
      {
        "color": {
          "name": "Test Color",
...
void main() {
  late ColorSuggestionsApiService service;

  group("Given a $ColorSuggestionsApiService with a null apiIndex", () {
    setUp(() {
      service = const ColorSuggestionsApiService(
  ...
  group("Given a $ColorSuggestionsApiService with a valid apiIndex", () {
    setUp(() {
      ...
      service = ColorSuggestionsApiService(
    ...
    group("when baseUri is called", () {
      test("then the request uri is properly built", () {
        expect(
          ...
          contains("https://test.com/suggestions/colors/random"),
        );
      });
    });
  ...
  group("Given a $ColorSuggestionsApiService with a failing http client", () {
    setUp(() {
      service = const ColorSuggestionsApiService(
